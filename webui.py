    ...
    with gr.Row():
            ...
            with gr.Row(visible=modules.config.default_image_prompt_checkbox) as image_input_panel:
                with gr.Tabs(selected=modules.config.default_selected_image_input_tab_id):
                    with gr.Tab(label='Upscale or Variation', id='uov_tab') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/anands3210/Creatify/discussions/390" target="_blank">\U0001F4D4 Documentation</a>')
                    with gr.Tab(label='Image Prompt', id='ip_tab') as ip_tab:
                        ...
                        gr.HTML('* \"Image Prompt\" is powered by Fooocus Image Mixture Engine (v1.0.1). <a href="https://github.com/anands3210/Creatify/discussions/557" target="_blank">\U0001F4D4 Documentation</a>')
                        ...
                        with gr.Row():
                            with gr.Column():
                                ...
                                example_inpaint_prompts = gr.Dataset(samples=modules.config.example_inpaint_prompts,
                                                                     ...
                                                                     visible=False)
                                gr.HTML('* Powered by Fooocus Inpaint Engine <a href="https://github.com/anands3210/Creatify/discussions/414" target="_blank">\U0001F4D4 Documentation</a>')
                    ...
                    with gr.Tab(label='Describe', id='describe_tab') as describe_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/anands3210/Creatify/discussions/1363" target="_blank">\U0001F4D4 Documentation</a>')
                    ...
                    with gr.Tab(label='Enhance', id='enhance_tab') as enhance_tab:
                        with gr.Row():
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/anands3210/Creatify/discussions/3281" target="_blank">\U0001F4D4 Documentation</a>')
        ...
        with gr.Column(scale=1, visible=modules.config.default_advanced_checkbox) as advanced_column:
            ...
            with gr.Tab(label='Advanced'):
                ...
                gr.HTML('<a href="https://github.com/anands3210/Creatify/discussions/117" target="_blank">\U0001F4D4 Documentation</a>')
